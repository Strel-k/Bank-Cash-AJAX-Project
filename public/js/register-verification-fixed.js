// Registration Verification JavaScript for B-Cash - FIXED VERSION
class RegistrationVerification {
    ...
    async uploadDocument(file, side) {
        ...
        // FORCE ADD VERIFICATION ID
        formData.append('verification_id', '11'); // Hardcode it
        console.log('FORCED verification_id to FormData: 11');
